...
<head>
    ...
    <title>{{ config('app.name', 'ODPP Asset Tag Generator') }}</title>
    ...
    <!-- Scripts -->
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ENjdO4Dr2bkBIFxQpeoA6DQD1KQ9Q8cbh6wr60P5r9E1z9jE3MoM9F6V8Qbsw3" crossorigin="anonymous">
...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ route('home') }}">TAG GENERATOR</a>
            <!-- Sidebar Toggle-->
